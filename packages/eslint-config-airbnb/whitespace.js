/* При слиянии веток branch1 и branch2 в этом месте файла
произошел конфликт. Для его разрешения следует объединить
информацию из обоих изменений. Но тк кода не было, тут будет этот текст.*/
